...
public class FakeThreadDownloadImageData {
    ...
    private interface IThreadDownloadImageDataBuilder {
        ResourceTexture build(File cacheFile, String imageUrl, Identifier textureResourceLocation, BufferedImageSkinProvider imageBuffer, MinecraftProfileTexture.Type textureType);
    }
