...
public class FakeClientPlayer {
    //For Legacy Skin
    public static PlayerSkinTexture	loadSkin(Identifier resourceLocationIn, String username) {
        ...
        if (ito == null || !(ito instanceof PlayerSkinTexture)) {
            ...
            skinman.method_7043(offlineProfile, (class_1890) new LegacyBuffer(resourceLocationIn), false);
        }
    ...
    public static class LegacyBuffer implements class_1890 {
        ...
        @Override
        public void method_7047(Type typeIn, Identifier location) {
